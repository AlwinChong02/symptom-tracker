...
import type { MessageType, MessageDialogProps } from '@/types/ui';
...
export default function MessageDialog({ open, type = "info", title, message, onClose, loading = false, loadingMessage = "Processing..." }: MessageDialogProps) {
  if (!open) return null;
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex justify-end gap-2 px-5 pb-4">
              <button onClick={onClose} className="rounded-full bg-green-600 px-6 py-2 font-semibold text-white hover:bg-green-700 transition-colors">OK</button>
            </div>
          </>
        )}
      </div>
