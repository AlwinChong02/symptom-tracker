  ...
  return (
    <header className="barlow fixed top-4 left-0 right-0 z-50">
      <div className="mx-4 sm:mx-6 lg:mx-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 bg-white/80 backdrop-blur border border-gray-200 shadow-lg rounded-2xl">
            ...
            <nav className="hidden md:flex md:items-center md:space-x-10">
              {user ? (
                <>
                  ...
                  <Link href="/medication-reminders" className="font-medium text-gray-600 hover:text-gray-900">Reminders</Link>
